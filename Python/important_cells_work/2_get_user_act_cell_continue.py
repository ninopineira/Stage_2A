...
def separate_day(cells : list[str], stamps : list[int],  
    ...
    cells_activity,stamps_activity = [],[]
    ...
    return cells_activity, stamps_activity
...
def get_user_cells(cells_activity, stamps_activity, useful_merge_count_300, activity_stay_time : int | None = 18000, merge_func : Callable[[str], str] = None):
    """
...
def process_user_activity(cells : list[str], stamps : list[int], 
                          activity_start : int | None = 18000, activity_end : int | None = 68400,
                          useful_merge_count_300 : int | None = 0, merge_func : Callable[[str], str] | None = None):
    """
    ...
    cells_activity, stamps_activity= separate_day(cells=cells, stamps=stamps, activity_start = activity_start, activity_end = activity_end)
